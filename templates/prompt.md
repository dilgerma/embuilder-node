...
2. if the slice is in status planned and not assigned, assign it to backend_worker (property assigned in ) and continue with backend_prompt.md. Ignore the rest of this file.
3. if the slice is in status planned and assigned to ui_worker, continue with ui_prompt.md. Ignore the rest of this file.